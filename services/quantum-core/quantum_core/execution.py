...
def run_vqe_sync(
    ...
    return {
        ...
        "active_space_energy": result.electronic_energy,
        "electronic_energy": result.electronic_energy + molecule.inactive_energy,
        "nuclear_repulsion": molecule.nuclear_repulsion,
        "inactive_energy": molecule.inactive_energy,
        "energy_offset": molecule.total_energy_offset,
